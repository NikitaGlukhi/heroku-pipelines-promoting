...
try {
  ...
  child_process.execSync(createCatFile(heroku));
  console.log('Created and wrote to ~./netrc');
  child_process.execSync(`git config user.name "Heroku-Deploy"`);
  child_process.execSync(`git config user.email "${heroku.email}"`);
